...
!function (e, t) {
    ...
    function c(t, Prism) {
        ...
        var n = Prism.toString(), c = u.toString();
        c += a.toString(), c += r.toString(), c += i.toString(), c += s.toString(), c += o.toString(), c += n;
        var f = c + "\tthis.onmessage=" + t.toString(), l = new Blob([f], {type: "text/javascript"});
    ...
    function p(e, t) {
        for (var r = {c: 0}, a = 0, o = e; a < o.length; a += 1) {
            ...
            if (!i.classList.contains("rainbow") && u) {
                ...
                var s = i.getAttribute("data-global-class"), c = parseInt(i.getAttribute("data-delay"), 10);
                ++r.c, d(v(i.innerHTML, {language: u, globalClass: s, delay: c}), g(i, r, t))
            }
        }
        0 === r.c && t()
    }
        ...
        function l(r, a, i) {
            function c(e) {
                return r.name && (e = n(r.name, e)), p[y] = {
                    replace: m[0],
                    "with": e
                }, h[y] = w, !g && {remaining: a.substr(w - i), offset: w}
            }

            function l(t) {
                var a = m[t];
                if (a) {
                    var i = r.matches[t], u = i.language, c = i.name && i.matches ? i.matches : i,
                        f = function (e, r, a) {
            ...
            var b = m[0], y = m.index + i, w = m[0].length + y;
            if (y === w) return !1;
    ...
    x = {extend: w, remove: N, onHighlight: y, addAlias: E, color: L}, R && (x.colorSync = function (e, t) {
...
Rainbow.extend("c", [{
...
}], "generic"), Rainbow.extend("csharp", [{name: "constant", pattern: /\b(false|null|true)\b/g}, {
    name: "keyword",
    ...
    matches: {1: "keyword.namespace", 2: {name: "support.namespace", pattern: /\w+/gm}},
...
}, {name: "string", pattern: /("|')(.*?)\1/gm}, {name: "integer", pattern: /\b(0x[\da-f]+|\d+)\b/gm}, {
    name: "comment",
...
}, {matches: {1: "storage.type", 2: "entity.name.type"}, pattern: /\b(type)\s+(\w+)\b/gi}, {
    name: "storage.type",
    ...
    matches: {
        1: {
            matches: {
                1: "public.stylesheets.style",
                2: [{name: "public.stylesheets.style", pattern: /^style/g}, {
                    name: "string",
                    pattern: /('|")(.*?)(\1)/g
                }, {name: "public.stylesheets.style.attribute", pattern: /(\w+)/g}],
                3: "public.stylesheets.style"
            }, pattern: /(&lt;\/?)(style.*?)(&gt;)/g
        },
        2: {language: "css"},
        3: "public.stylesheets.style",
        4: "public.stylesheets.style",
        5: "public.stylesheets.style"
    },
...
}]), Rainbow.extend("php", [{name: "support", pattern: /\becho\b/gi}, {
    matches: {
    ...
    pattern: /(\(|,\s?)([\w\\]*?)(?=\s\$)/g
}], "generic"), Rainbow.extend("python", [{name: "variable.self", pattern: /self/g}, {
    name: "constant.language",
    ...
    matches: {
        ...
        2: [{
            ...
            matches: {1: "string.open", 2: {language: "ruby"}, 3: "string.close"},
            pattern: /(\#\{)(.*?)(\})/g
        }],
        3: "string.close"
    },
